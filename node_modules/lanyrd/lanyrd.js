...
var Lanyrd = {
  ...
  search: function (query, page, context, cb){
    this.get('search/?q='+query+'&page='+page+'&context='+context, function(error, response, body){
      console.log(body);
      if (body['sections'].length > 0) {
        cb(error, response, body['sections'][0]['rows']); // callback in app.js
      } else {
        var emptyArr = [];
        cb(error, response, emptyArr);
      }
    })
  },
